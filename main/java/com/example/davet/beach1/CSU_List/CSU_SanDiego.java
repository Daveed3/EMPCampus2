...
public class CSU_SanDiego extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU San Diego";
    private final String ADDRESS = "5350 55th Street San Diego, CA 92182";
    private final String NUM_STRING = "(619) 594-1991";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__san_diego); //change this one to the respective XML Layout
