...
public class CSU_EastBay extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU East Bay";
    private final String ADDRESS = "25800 Carlos Bee Blvd, Hayward, CA 94542";
    private final String NUM_STRING = "(510)885-3791";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__eastbay); //change this one to the respective XML Layout
