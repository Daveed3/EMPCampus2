...
public class CSU_LongBeach extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Long Beach";
    private final String ADDRESS = "1250 Bellflower Blvd. Long Beach, CA 90840";
    private final String NUM_STRING = "(562) 985-4101";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__longbeach); //change this one to the respective XML Layout
