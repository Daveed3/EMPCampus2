...
public class CSU_SanMarcos extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU San Marcos";
    private final String ADDRESS = "333 S Twin Oaks Valley Road, San Marcos, CA 92096";
    private final String NUM_STRING = "(760) 750-4567";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__san_marcos); //change this one to the respective XML Layout
