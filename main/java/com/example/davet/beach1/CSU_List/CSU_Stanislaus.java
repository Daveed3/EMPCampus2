...
public class CSU_Stanislaus extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Stanislaus";
    private final String ADDRESS = "One University Circle, Turlock, CA 95382";
    private final String NUM_STRING = "(209) 667-3114";
