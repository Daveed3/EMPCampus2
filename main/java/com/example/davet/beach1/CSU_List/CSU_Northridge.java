...
public class CSU_Northridge extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Northridge";
    private final String ADDRESS = "18111 Nordhoff Street, Northridge, CA 913306";
    private final String NUM_STRING = "(818) 677-2111";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__northridge); //change this one to the respective XML Layout
