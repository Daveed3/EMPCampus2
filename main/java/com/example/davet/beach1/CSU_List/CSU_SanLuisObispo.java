...
public class CSU_SanLuisObispo extends AppCompatActivity implements InfoTemplate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__san_luis_obispo); //change this one to the respective XML Layout
