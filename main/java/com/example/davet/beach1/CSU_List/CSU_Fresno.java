...
public class CSU_Fresno extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Fresno";
    private final String ADDRESS = "2311 E Barstow Ave Fresno, CA 93740-8004";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__fresno); //change this one to the respective XML Layout
