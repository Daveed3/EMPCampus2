...
public class CSU_Sacramento extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Sacramento";
    private final String ADDRESS = "6000 J St, Sacramento, CA 95819";
    private final String NUM_STRING = "(916) 278-6000";
