...
public class CSU_Fullerton extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Fullerton";
    private final String ADDRESS = "800 N State College Blvd, Fullerton, CA 92831";
    private final String NUM_STRING = "(657) 278-2515";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__fullerton); //change this one to the respective XML Layout
