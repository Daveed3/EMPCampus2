...
public class CSU_Pomona extends AppCompatActivity implements InfoTemplate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__pomona); //change this one to the respective XML Layout
