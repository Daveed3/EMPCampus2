...
public class CSU_Humboldt extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "Humboldt State University";
    private final String ADDRESS = "1 Harpst St, Arcata, CA 95521";
    private final String NUM_STRING = "(707) 826-5555";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__humboldt); //change this one to the respective XML Layout
