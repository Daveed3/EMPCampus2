...
public class CSU_Cal_Maritime extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU Cal Maritime";
    private final String ADDRESS = "200 Maritime Academy Drive, Vallejo, CA 94590";
    private final String NUM_STRING = "707-654-1111";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__cal__maritime); //change this one to the respective XML Layout
