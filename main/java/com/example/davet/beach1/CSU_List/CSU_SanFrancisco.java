...
public class CSU_SanFrancisco extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU San Francisco";
    private final String ADDRESS = "1600 Holloway Avenue, San Francisco, CA 94132";
    private final String NUM_STRING = "(415) 338-7200";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__san_francisco); //change this one to the respective XML Layout
