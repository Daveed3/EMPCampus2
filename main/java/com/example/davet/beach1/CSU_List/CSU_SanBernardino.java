...
public class CSU_SanBernardino extends AppCompatActivity implements InfoTemplate {
    private final String SCHOOL_NAME = "CSU San Bernardino";
    private final String ADDRESS = "5500 University Pkwy, San Bernardino, CA 92407";
    private final String NUM_STRING = "(909) 537-5999";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csu__sanbernardino); //change this one to the respective XML Layout
